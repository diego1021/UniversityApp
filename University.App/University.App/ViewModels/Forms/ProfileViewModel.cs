    ...
    public class ProfileViewModel : BaseViewModel
    {
        ...
        async void AddImage()
        {
            try
            {
                ...
                var source = await Application.Current.MainPage.DisplayActionSheet(Languages.FountPhoto,
                    Languages.Accept,
                    null,
                ...
                else if (source.Equals(Languages.TakePhoto))
                {
                ...
                if(this._file != null)
                {
                    this._imageSource = ImageSource.FromStream(() =>
                    {

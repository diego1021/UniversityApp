        ...
        public async Task<IHttpActionResult> GetUser(string userID)
        {
            try
            {
                ...
                if(user != null)
                {
                    ...
                    var isExistsFile = BL.Helpers.Utils.IsExistFile(path);
                    ...
                    var userDTO = new UserDTO
                    {
                        ...
                        Email = user.Email,
                        UserName = user.UserName,
                        Image = isExistsFile ? filePath + fileName : string.Empty,
                        ImageBase64 = isExistsFile ? Convert.ToBase64String(File.ReadAllBytes(path)) : string.Empty
                    };
